...
3. Write the digest to `.excn/research/prior-art-<prd-id>-<prd-slug>.md` (lowercase prd id plus the source PRD's filename slug, e.g. `prior-art-prd-007-visible-tracking-and-hook-scaffolding.md`; overwrite your own prior run for the same PRD). Its sections:
